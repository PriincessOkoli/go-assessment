...
export default function ErrorFallback(props: ErrorFallback) {
  ...
  return (
    <div className="h-96 grid place-items-center">
      <div className="rounded-lg bg-white  flex flex-col items-center w-full mx-auto max-w-md">
        <div className="rounded-full h-[5rem] w-[5rem] bg-error text-brand-50 flex items-center justify-center">
